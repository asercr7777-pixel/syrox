  ...
  return <div className="space-y-6">
    ...
    <section className="card p-4 sm:p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div><p className="mb-2 text-sm text-ink-300">Goal</p><div className="grid grid-cols-2 gap-2"><button type="button" onClick={() => setGoal('strength')} className={optionClass(goal === 'strength')}><b>Strength</b><p className="mt-1 text-[11px] text-ink-500">Build strength</p></button><button type="button" onClick={() => setGoal('fitness')} className={optionClass(goal === 'fitness')}><b>Fitness</b><p className="mt-1 text-[11px] text-ink-500">Improve fitness</p></button><button type="button" onClick={() => setGoal('mobility')} className={optionClass(goal === 'mobility')}><b>Mobility</b><p className="mt-1 text-[11px] text-ink-500">Move better</p></button><button type="button" onClick={() => setGoal('sports')} className={optionClass(goal === 'sports')}><b>Sports</b><p className="mt-1 text-[11px] text-ink-500">Athletic performance</p></button></div></div>
        <div><p className="mb-2 text-sm text-ink-300">Equipment</p><div className="grid grid-cols-3 gap-2"><button type="button" onClick={() => setEquipment('bodyweight')} className={optionClass(equipment === 'bodyweight')}><b>Bodyweight</b><p className="mt-1 text-[11px] text-ink-500">No equipment</p></button><button type="button" onClick={() => setEquipment('home')} className={optionClass(equipment === 'home')}><b>Home</b><p className="mt-1 text-[11px] text-ink-500">Basic equipment</p></button><button type="button" onClick={() => setEquipment('gym')} className={optionClass(equipment === 'gym')}><b>Gym</b><p className="mt-1 text-[11px] text-ink-500">Full gym</p></button></div></div>
