...
export const RANKS: Rank[] = [
  ...
  { id: 'A', name: 'A-Rank', emoji: '✪', color: '#eab308', glow: 'rgba(234,179,8,0.5)', xpRequired: 6000, description: 'Elite of the awakened.', dungeon: { name: 'Inferno Spire', xpReward: 320 }, rewards: [{ type: 'aura', itemId: 'solar', label: 'Solar Aura' }, { type: 'shield', itemId: 'shadow_aegis', label: 'Shadow Aegis' }], tier: 'gold' },
  { id: 'S', name: 'S-Rank', emoji: '⚔', color: '#f97316', glow: 'rgba(249,115,22,0.6)', xpRequired: 8500, description: 'A force to be reckoned with.', dungeon: { name: "Demon's Lair", xpReward: 460 }, rewards: [{ type: 'aura', itemId: 'crimson', label: 'Crimson Aura' }, { type: 'title', itemId: 'demon_hunter', label: 'Demon Hunter Title' }], tier: 'fire' },
  { id: 'SS', name: 'SS-Rank', emoji: 'ϟ', color: '#facc15', glow: 'rgba(250,204,21,0.7)', xpRequired: 11500, description: 'Lightning courses through you.', dungeon: { name: 'Void Sanctum', xpReward: 600 }, rewards: [{ type: 'aura', itemId: 'azure', label: 'Azure Aura' }, { type: 'weapon', itemId: 'storm_spear', label: 'Storm Spear' }], tier: 'lightning' },
  ...
  { id: 'DOOM_BRINGER', name: 'Doom Bringer', emoji: '✹', color: '#b91c1c', glow: 'rgba(185,28,28,0.9)', xpRequired: 46500, description: 'The harbinger of doom.', dungeon: { name: 'Doom Crucible', xpReward: 2500 }, rewards: [{ type: 'aura', itemId: 'ragnarok', label: 'Ragnarok Aura' }, { type: 'weapon', itemId: 'ragnarok_axe', label: 'Ragnarok Axe' }], tier: 'fire' },
  { id: 'EXECUTIONER', name: 'Executioner', emoji: '†', color: '#16a34a', glow: 'rgba(22,163,74,0.9)', xpRequired: 53500, description: 'The final judgment falls.', dungeon: { name: "Executioner's Block", xpReward: 2900 }, rewards: [{ type: 'aura', itemId: 'dragon', label: 'Dragon Aura' }, { type: 'weapon', itemId: 'dragon_kings_spear', label: "Dragon King's Spear" }], tier: 'green' },
