...
// One clean pipeline: preserve the existing story/cutscenes and only replace
// mission presentation with short, actionable objectives.
export const ALL_CHAPTERS: StoryChapter[] = directStory(REWORKED_STORY_CHAPTERS);
