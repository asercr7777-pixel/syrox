...
export type StoryEventType = 'workout_completed' | 'task_completed' | 'streak_increased' | 'day_completed' | 'return_after_absence' | 'milestone_reached' | 'dungeon_cleared' | 'chapter_completed';
...
const reactions: Record<StoryEventType, ShadowReaction> = {
  ...
  chapter_completed:{state:'revelation',title:'SHADOW // CHAPTER SEALED',lines:['You finished this chapter. The path ahead is no longer the same.','Keep moving. I will be waiting at the next threshold.'],priority:100},
};
...
export function getShadowImage(state: ShadowState): string {
  const images: Record<ShadowState,string> = {
    idle:'/shadow_idle.png.jpg',observing:'/shadow_observing.png.jpg',ready:'/shadow_ready.png.jpg',command:'/shadow_command.png.jpg',memory:'/shadow_memory.png.jpg',power:'/shadow_power.png.jpg',revelation:'/shadow_revelation.png.jpg',threat:'/shadow_threat.png.jpg',side:'/shadow_side.png.jpg',standing:'/shadow_standing.png.jpg',walking:'/shadow_walking.png.jpg',warning:'/shadow_warning.png.jpg'
  };
  return images[state] ?? images.standing;
}
