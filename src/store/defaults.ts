import type { AppState, WorkoutDayId } from './types';
...
const WORKOUT_DAY_IDS: WorkoutDayId[] = ['day1', 'day2', 'day3', 'day4', 'day5', 'day6'];
const WORKOUT_DAY_EMOJIS = ['🔥', '⚡', '🦾', '🗡️', '👑', '💀'];
const STARTER_EXERCISES = [
  DEFAULT_EXERCISES.push,
  DEFAULT_EXERCISES.pull,
  DEFAULT_EXERCISES.leg,
  DEFAULT_EXERCISES.push,
  DEFAULT_EXERCISES.pull,
  DEFAULT_EXERCISES.leg,
];
...
function createStarterWorkouts() {
  return Object.fromEntries(WORKOUT_DAY_IDS.map((id, index) => [id, {
    dayId: id,
    name: `Day ${index + 1}`,
    emoji: WORKOUT_DAY_EMOJIS[index],
    exercises: STARTER_EXERCISES[index].map((e) => ({ id: uid(), ...e, completed: false })),
  }])) as AppState['workouts'];
}
...
export function createDefaultState(): AppState {
  ...
  const workouts = createStarterWorkouts();
  ...
  return {
    ...
    workouts, workoutsCompletedToday: 0, workoutRewardsClaimedToday: Object.fromEntries(WORKOUT_DAY_IDS.map((id) => [id, false])) as Record<WorkoutDayId, boolean>, lastWorkoutDate: null, workoutSessions: [], totalWorkoutSeconds: 0,
    schedule: [
    ...
    lastLoginClaimDate: null, loginStreak: 0, lastSpinDate: null, lastSpinRewardId: null,
    dailyChallengeIds: [], dailyChallengeCompleted: {}, dailyChallengeDate: null, weeklyMissionIds: [], weeklyMissionCompleted: {}, weeklyMissionWeek: null,
    ...
    backgroundType: 'default', customBackground: null, backgroundVideo: null, backgroundBlur: 0, backgroundDarken: 40, backgroundBrightness: 100, selectedBackgroundId: null,
    achievements: [], history: [], notes: {}, chat: [{ id: uid(), role: 'ai', text: "Welcome, Hunter. I am your AI Coach. I'll analyze your performance, suggest tasks, and push you toward the next rank. Complete your core tasks today — the path to Shadow Monarch begins with a single push-up.", at: Date.now() }],
    friends: [
    ...
    storyChapter: 0, storyMission: 0, storyChoices: {}, storyCompletedMissions: {}, storyBossDefeated: {}, storyNpcReputation: {}, storyLoreUnlocked: [], storyAchievements: [],
    activeBossId: null, bossHpRemaining: {}, bossDefeated: {}, chestInventory: { common_chest: 1 }, petId: null, petLevel: 1, petXp: 0,
    battlePassTier: 1, battlePassXp: 0, battlePassPremium: false, battlePassClaimedFree: [], battlePassClaimedPremium: [], lastFortuneDate: null, lastFortuneLuck: 3, lastFortuneQuote: '', milestoneClaimed: [], prestigeLevel: 0, prestigeMultiplier: 1,
    dailyShopSeed: null, dailyShopDate: null, secretShopAvailable: false, secretShopExpiresAt: null, searchHistory: [], rankRewardsClaimed: [],
  };
}
